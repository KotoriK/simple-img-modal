...
const FloatButton = forwardRef(
    function FloatButton({ children, refFloat }: FloatButtonProps, ref) {
        ...
        const refresh = useCallback(() => {
            ...
            const { y, width, x } = ele.getBoundingClientRect()
            const computedLeft = width + x / 2 - 15;
            setTop(y)
